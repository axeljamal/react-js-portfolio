      ...
      <div className="contactContainer">
        ...
        <div className="contactRight">
          ...
          <div className="contactEmail">
            <h2>Email</h2>
            <a className="email" href="mailto:best.amiker@gmail.com">
              best.amiker@gmail.com
            </a>
          </div>
          <div className="contactEmail">
            <h2>Phone</h2>
            <a className="email" href="tel:07738398290">
              +44 773 839 8290
            </a>
          </div>
          <div className="social">
            <a
              href="https://www.linkedin.com/in/amikerbest/"
              rel="noreferrer"
              target="_blank"
            >
